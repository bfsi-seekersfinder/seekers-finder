  ...
  return (
    <div className="flex ">
        ...
        <div className="bg-gray-100 w-full h-screen ">
            {Step===0?(
            <div>
              <nav className="w-full h-12 shadow flex items-center justify-between px-8 ">
              <div>
                <span className="text-2xl font-bold text-slate-600">Talent<span className=" text-orange-500 ">X</span></span>
              </div>
              <div className="flex gap-8 text-xl text-slate-600">
                <span onClick={()=>setStep(6)} className="px-2 py-0.5 shadow rounded-sm bg-white cursor-pointer "><i className="ri-notification-2-line"></i></span>
