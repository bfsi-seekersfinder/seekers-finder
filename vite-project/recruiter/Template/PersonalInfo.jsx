      ...
      {Step === 1? (
        <div className=''>
            <div className='flex flex-col gap-4'>
                <span className='bg-white shadow py-4 px-4 text-slate-600 font-semibold flex justify-between'>Account Type <span className='flex gap-12 cursor-pointer'>{user?.role}</span></span>
                <span className='bg-white shadow py-4 px-4 text-slate-600 font-semibold flex justify-between'>User Name <span className='flex gap-12 cursor-pointer'>{user?.recruiterName}</span></span>
